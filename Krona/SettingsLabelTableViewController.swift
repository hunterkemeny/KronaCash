...
class SettingsLabelTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.nameLabel.text = label.name
    ...
    */
    ...
    private func loadLabels() {
        let label1 = SettingsLabel(name: "Profile")
        let label2 = SettingsLabel(name: "Membership")
        let label3 = SettingsLabel(name: "TOS")
        let label4 = SettingsLabel(name: "Support")
